export const HttpStatusCodes = {
  ...
  REQUEST_TOO_LONG: 413 as const,
  REQUEST_URI_TOO_LONG: 414 as const,
  REQUESTED_RANGE_NOT_SATISFIABLE: 416 as const,
